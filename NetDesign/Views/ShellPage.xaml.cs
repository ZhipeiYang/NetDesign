...
namespace NetDesign.Views
{
    ...
    {
        //创建用于保存IEEEPage页面的内容和页面间值传递的对象ieee
        public static View_IEEE ieee = new View_IEEE();
        ...
        private void PopulateNavItems()
        {
            ...
            //创建页面导航标签，包括IEEEPage，CRCPage和Settings
            _primaryItems.Add(ShellNavigationItem.FromType<IEEEPage>("Shell_IEEE".GetLocalized(), Symbol.Globe));
            _primaryItems.Add(ShellNavigationItem.FromType<CRCPage>("Shell_CRC".GetLocalized(), Symbol.View));
            _primaryItems.Add(ShellNavigationItem.FromType<RecordPage>("Shell_Record".GetLocalized(), Symbol.ShowBcc));
